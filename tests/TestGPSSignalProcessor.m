classdef TestGPSSignalProcessor < matlab.unittest.TestCase
    ...
    methods (TestMethodSetup)
        function setup(testCase)
            ...
            testCase.DSP = GPSSignalProcessor(11, 2,2.046e6, -0.1030e3);
    ...
    methods (Test)
        ...
        function testProcessFrame(testCase)
            ...
            % 100ms frames (5 bits) - Samples at 500ms total (25 bits)
            samplesPerFrame = 1023 * testCase.DSP.samplesPerChip* 250;
            subframe = testCase.GPS();
            B = (1023*testCase.DSP.samplesPerChip*250)+1;
